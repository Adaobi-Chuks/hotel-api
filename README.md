...
# Testing
This folder contains a Postman collection in the [Request.postman_collection.js](Request.postman_collection.js) file that you can import to Postman to test the endpoints.
