...
# Testing
This folder contains a Postman collection in the [Request.postman_collection.js](https://github.com/Adaobi-Chuks/hotel-api/blob/main/Request.postman_collection.json) file that you can import to Postman to test the endpoints.
